...
|-----------|-------------------|--------|---------------|-----------|
| Definir políticas | **A** | N/A | **R** | N/A |
| Revisar mudança de política (dry-run) | **A** | N/A | **R** | **I** |
| Conceder escopos | **A** | N/A | **R** | **I** |
| Registrar agente | N/A | N/A | **R** | **I** |
| Aprovar agente para prod | **A** | N/A | **R** | **I** |
| Aprovar ação de alto risco (HITL) | **R/A** | N/A | N/A | **I** |
| Aprovar ação crítica (M-de-N) | **R/A** (múltiplos) | N/A | N/A | **I** |
| Monitorar trilha de auditoria | **A** | N/A | **R** | **R** |
| Investigar incidente (forensics) | **A** | N/A | **R** | **R** |
| Ativar kill switch local | **R/A** | N/A | **C** | **I** |
| Ativar kill switch global | **R/A** (plataforma) | N/A | **C** | **I** |
| Revogar credencial | **A** | N/A | **R** | **I** |
| Gerenciar tenants | **A** (platform team) | N/A | **R** | **I** |
| Gerar relatório de compliance | N/A | N/A | **R** | **A** |
...
| Agente não aprovado em prod | AgentRegistry.can_run_in_prod | N/A |
| Trilha de auditoria adulterada | Hash chain SHA-256 | Assinatura Ed25519 |
| Dados pessoais expostos no log | PIIMasker (aplica antes do log) | N/A |
...
| Segredo exposto em variável de ambiente | SecretStore com TTL e access policy | N/A |
